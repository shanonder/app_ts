...
module ui.pub {
    export class RoleHeadUI extends View {

        public static  uiView:any ={"type":"View","props":{"width":200,"height":100}};
        constructor(){ super()}
        createChildren():void {
...
module ui.test {
    export class DemoUI extends Dialog {
